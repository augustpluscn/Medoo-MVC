...
class medoo
{
	protected $database_type = DATABASE_TYPE;

	// For MySQL, MariaDB, MSSQL, Sybase, PostgreSQL, Oracle
	protected $server = DATABASE_SERVER;

	protected $username = DATABASE_USER;

	protected $password = DATABASE_PWD;
	...
	//display templates function --add by laohai
	public function display( $data = NULL , $layout = NULL , $template = NULL )
	{
		...
		$layout_file = WROOT . 'view/' . $layout . '/' . $template . '.html';
